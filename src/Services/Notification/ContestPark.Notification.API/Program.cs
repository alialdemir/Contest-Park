...
using ContestPark.Notification.API.Infrastructure;
using ContestPark.Notification.API.Migrations;
            ...
            try
            {
                ...
                host.MigrateDatabase((services, updateDatabase) =>
                {
                    ...
                    updateDatabase(
                        ...
                        () =>
                        {
                            var logger = services.GetService<ILogger<NotificationApiSeed>>();

                            new NotificationApiSeed()
