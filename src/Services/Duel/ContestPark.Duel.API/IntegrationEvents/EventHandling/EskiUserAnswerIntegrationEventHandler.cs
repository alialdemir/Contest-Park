...
{
    public class EskiUserAnswerIntegrationEventHandler : IIntegrationEventHandler<UserAnswerIntegrationEvent>
    {
        ...
        public EskiUserAnswerIntegrationEventHandler(IUserAnswerRepository userAnswerRepository,
