...
using ContestPark.Mission.API.Infrastructure;
using ContestPark.Mission.API.Migrations;
    ...
    public class Program
    {
        ...
        public static int Main(string[] args)
        {
            ...
            try
            {
                ...
                {
                    var settings = services.GetService<IOptions<MissionSettings>>();
                    ...
                    updateDatabase(
                        ...
                        () =>
                        {
                            var logger = services.GetService<ILogger<MissionApiSeed>>();
