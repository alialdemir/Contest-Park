...
[assembly: ExportRenderer(typeof(CircularProgress), typeof(CustomEntryRenderer))]
namespace ContestPark.Mobile.iOS.CustomRenderer
{
    public class CircularProgressRenderer : VisualElementRenderer<CircularProgress>
    {
